...
# 27/11/15
# * Added code paramter for addException
# * Retabbed
# * Added Unicode decoding
# * XML escaping
...
class MaltegoEntity(object):
    ...
    def setNote(self,note):
        self.addProperty('notes#','Notes','loose',note)                     
...
# ..Sorry - RT 
    ...
    def addException(self,exceptionString,code):
        self.exceptions.append((exceptionString,code))
